...
NPolitics = {
	...
	BASE_POLITICAL_POWER_INCREASE = 2.5,	-- Weekly increase of PP.
...
NAI = {
	...
	WANTED_UNITS_MANPOWER_DIVISOR = 10000,                      -- Normalizing divisor for AI manpower. (for each x max available manpower, they want one division)
